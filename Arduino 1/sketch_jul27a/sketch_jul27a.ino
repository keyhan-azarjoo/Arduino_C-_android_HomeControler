...
void loop() {
  ...
  {
    //HTTPClient http;
    //String url = "http://keyhantest.speedyserver.ir/home/setg?str=ff1";
    //http.begin(url);
    //http.addHeader("Connect.Type","text/plain");
    //int httpCode = http.GET();
    //String payload = http.getString();
    //Serial.println("send and ansver is " + payload);
    //http.end();
    ...
    gh.begin("http://keyhantest.speedyserver.ir/home/setg?str=ff"); //Specify the URL
    gh.end(); //Free the resources
